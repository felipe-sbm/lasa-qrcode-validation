...
export const participantes: Participante[] = [
  ...
  {
    id: "4",
    nome: "Marcelo Edgleyson de Oliveira Freire",
    cargo: "Diretor Técnico e Sócio",
    instituicao: "Cabugi Serviços",
    foto: "/members/marcelo.webp",
    bio: "Especialista em geotecnologias. Técnico em Edificações pelo IFRN (2008-2009). Topógrafo na Metro topografia (2009-2010). Coordenador de Mina na Mineradora Nosso Senhor do Bonfim (2011-2019). Diretor técnico e sócio na Cabugi Serviços (2019-presente). Especialização em Geotecnologias pelo Instituto Iquality (2020).",
    email: ""
  },
  {
    id: "5",
